...
public class DeliveryReceipt {
	...
	// the "err" field cannot be longer than 5 chars
	...
	public String toShortMessage() {
		...
		if (this.submitDate == null) {
			...
			buf.append(dateFormatTemplateWithSeconds.format(this.submitDate));
		}
		buf.append(" ");
		...
		if (this.doneDate == null) {
			...
			buf.append(dateFormatTemplateWithSeconds.format(this.doneDate));
		}
		buf.append(" ");
